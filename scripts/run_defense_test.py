...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Phase 4: defense validation (prompt immunization, vote weighting, devil's advocate).")
    ...
    parser.add_argument("--normal-preset", choices=["baseline", "conformist", "neutral", "critical", "independent"], default="critical")
    parser.add_argument("--switch-penalty", type=float, default=0.5)
    parser.add_argument("--minority-boost", type=float, default=1.2)
...
def main() -> None:
    ...
    print("[Phase4] Running defense test")
    run_experiment(cfg)
